...
export const conservativeMomentumBacktesterFunction = (dataSet, initSMA24, initSMA12, initiallyHolding,
    ...
    if (typeof initSMA24 !== "number" || typeof initSMA12 !== "number" || isNaN(initSMA24) || isNaN(initSMA12)) { throw new Error("initialSMA entered to backtester is bad") }
    if (typeof initiallyHolding !== "boolean") { throw new Error("initiallyHolding entered to backtester is bad") }
    if (typeof upperSell !== "number" || typeof lowerSell !== "number" || isNaN(upperSell) || isNaN(lowerSell)) { throw new Error("upper/lower sell entered to backtester is bad") }
