...
import { DATE_FORMAT, MATCH_TICKER } from '../content/constants'
...
export const getSmaDataPoint = async (ticker, date, days) => {
    ...
    */
    ...
    if (typeof ticker !== 'string' || !MATCH_TICKER.test(ticker)) throw new Error(`Ticker entered is invalid in getSmaDataPoint function. Got: ${ticker}`)
